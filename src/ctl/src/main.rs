...
fn print_usage() {
    eprintln!("Usage:");
    eprintln!("  boltctl put <key> <value> [database_id]");
    eprintln!("  boltctl get <key> [database_id]");
    eprintln!("  boltctl del <key> [database_id]");
    eprintln!("  boltctl setex <key> <ttl_seconds> <value> [database_id]");
    eprintln!("  boltctl ttl <key> [database_id]");
    eprintln!("  boltctl mget <key1> <key2> ... [--db database_id]");
    eprintln!("  boltctl mset <key1> <val1> <key2> <val2> ... [--db database_id]");
    eprintln!("  boltctl mdel <key1> <key2> ... [--db database_id]");
    eprintln!();
    eprintln!("Counter operations:");
    eprintln!("  boltctl incr <key> [database_id]");
    eprintln!("  boltctl decr <key> [database_id]");
    eprintln!("  boltctl incrby <key> <delta> [database_id]");
    eprintln!();
    eprintln!("CRDT Counter operations (distributed/multi-master safe):");
    eprintln!("  boltctl cincr <key> [database_id]      - CRDT increment");
    eprintln!("  boltctl cdecr <key> [database_id]      - CRDT decrement");
    eprintln!("  boltctl cget <key> [database_id]       - Get CRDT counter value");
    eprintln!("  boltctl cincrby <key> <amount> [database_id] - CRDT increment by");
    eprintln!();
    eprintln!("List operations:");
    eprintln!("  boltctl lpush <key> <val1> [val2...] [--db database_id]");
    eprintln!("  boltctl rpush <key> <val1> [val2...] [--db database_id]");
    eprintln!("  boltctl lpop <key> [database_id]");
    eprintln!("  boltctl rpop <key> [database_id]");
    eprintln!("  boltctl lrange <key> <start> <stop> [database_id]");
    eprintln!("  boltctl llen <key> [database_id]");
    eprintln!();
    eprintln!("Set operations:");
    eprintln!("  boltctl sadd <key> <member1> [member2...] [--db database_id]");
    eprintln!("  boltctl srem <key> <member1> [member2...] [--db database_id]");
    eprintln!("  boltctl smembers <key> [database_id]");
    eprintln!("  boltctl scard <key> [database_id]");
    eprintln!("  boltctl sismember <key> <member> [database_id]");
    eprintln!();
    eprintln!("Utility operations:");
    eprintln!("  boltctl exists <key> [database_id]");
    ...
    eprintln!("  boltctl users                                 - List all users");
    eprintln!("  boltctl passwd <username> <new_password>      - Change user password");
    eprintln!("  boltctl role <username> <new_role>            - Change user role");
    eprintln!("  boltctl whoami                                - Show current user info");
    eprintln!();
    eprintln!("Server operations:");
    eprintln!("  boltctl stats");
